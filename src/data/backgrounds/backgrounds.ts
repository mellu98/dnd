...
export const wayfarer: Background = {
  ...
  originFeat: {
    ...
    descriptionIT: 'La tua velocità aumenta di 10 piedi. Quando usi l\'azione Scatto, il terreno difficile non costa movimento extra. Quando effettui un attacco in mischia contro una creatura, non provochi attacchi di opportunità da quella creatura per il resto del turno.',
    level: 1,
  },
