...
export const elf: Race = {
  ...
  features: [
    ...
    },
    {
      name: 'Trance',
      nameIT: 'Transe',
      description: 'Elves don\'t need to sleep. Instead, they meditate deeply for 4 hours a day, gaining the same benefit as 8 hours of sleep.',
      ...
      features: [
        {
          ...
          descriptionIT: 'La tua velocità base aumenta a 10,5 metri (35 piedi).',
          level: 1,
        },
        {
      ...
      features: [
        {
          ...
          descriptionIT: 'La tua scurovisione ha un raggio di 36 metri (120 piedi) invece di 18 metri.',
          level: 1,
        },
        {
        ...
        },
        {
          ...
          descriptionIT: 'Conosci il trucchetto luci danzanti. Al 3° livello puoi lanciare fuoco fatuo una volta per riposo lungo, e al 5° livello oscurità una volta per riposo lungo. Carisma è la tua caratteristica da incantatore.',
          level: 1,
        },
      ],
      proficiencies: [
