...
export const elf: Species = {
  ...
  features: [
    ...
    // Drow variants
    {
      ...
      description: 'Your darkvision has a radius of 120 feet instead of 60 feet (Drow variant).',
      descriptionIT: 'La tua scurovisione ha un raggio di 36 metri (120 piedi) invece di 18 metri (variante Drow).',
      level: 1,
    },
    {
      name: 'Sunlight Sensitivity',
      nameIT: 'Sensibilità alla Luce Solare',
      description: 'You have disadvantage on attack rolls and Perception checks that rely on sight when you or your target is in direct sunlight (Drow variant).',
      descriptionIT: 'Hai svantaggio ai tiri per colpire e alle prove di Percezione basate sulla vista quando tu o il bersaglio siete alla luce diretta del sole (variante Drow).',
      level: 1,
    },
    {
      name: 'Drow Magic',
      nameIT: 'Magia Drow',
      description: 'You know the dancing lights cantrip. At 3rd level you can cast faerie fire once per long rest, and at 5th level darkness once per long rest. Charisma is your spellcasting ability (Drow variant).',
      descriptionIT: 'Conosci il trucchetto luci danzanti. Al 3° livello puoi lanciare fuoco fatuo una volta per riposo lungo, e al 5° livello oscurità una volta per riposo lungo. Carisma è la tua caratteristica da incantatore (variante Drow).',
      level: 1,
    },
  ],
  proficiencies: [
  ...
  variants: ['Alto Elfo', 'Elfo dei Boschi', 'Drow'],
}
